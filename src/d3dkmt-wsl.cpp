...
DEFINE_KMT(WaitSyncFile, D3DKMT_WAITSYNCFILE, 0x46, CONST)
DEFINE_KMT(OpenSyncObjectFromSyncFile, D3DKMT_OPENSYNCOBJECTFROMSYNCFILE, 0x47, NONCONST)
DEFINE_KMT(EnumProcesses, D3DKMT_ENUMPROCESSES, 0x48, NONCONST)
DEFINE_KMT(IsFeatureEnabled, D3DKMT_ISFEATUREENABLED, 0x49, NONCONST)
